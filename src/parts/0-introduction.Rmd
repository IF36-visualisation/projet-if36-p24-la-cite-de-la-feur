...
Le paramètre *watchers* est une donnée supplémentaire d'analyse de "popularité". Quand un utilisateur *watchs* (que l'on peut traduire par surveiller ou suivre, en français) un projet, il est averti quand ce dernier subit une modification.
...
df <- read_csv("../../data/data_1_200000")
```
